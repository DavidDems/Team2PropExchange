  ...
  <form id="propertyForm" method="POST" action="{{route('properties.store')}}" enctype="multipart/form-data">
    ...
    <div class="row">
      <div class="col-md-3 mb-3">
        ...
        <input type="number" class="form-control" name="floors" id="floors" required>
      </div>
      <div class="col-md-3 mb-3">
      ...
      <div class="col-md-3 mb-3">
        ...
        <input type="number" class="form-control" name="squareFootage" id="squareFootage" required>
      </div>
    </div>

    <div class="mb-3">
      <label for="yearBuilt" class="form-label">Year Built</label>
      <input type="number" class="form-control" name="yearBuilt" id="yearBuilt" required>
    </div>
